module github.com/merlinfuchs/embed-generator/embedg-service

go 1.25.0

require (
	endobit.io/clog v0.6.0
	...
	github.com/merlinfuchs/stateway/stateway-lib v0.0.0-20251115132945-386a584ba34f
