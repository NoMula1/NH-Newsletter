...
func (g *EmbedGenerator) SyncCommands(ctx context.Context) error {
	if err := handler.SyncCommands(g.Client(), commands, []common.ID{}, rest.WithCtx(ctx)); err != nil {
...
func (g *EmbedGenerator) interactionMux() *handler.Mux {
	...
	mx.Command("/Format Mention", g.handleUserFormatMentionContextCommand)
...
func (g *EmbedGenerator) handleMessageRestoreCommand(e *handler.CommandEvent) error {
	...
	message, err := g.Client().Rest.GetMessage(channelID, messageID, rest.WithCtx(e.Ctx))
	if err != nil {
